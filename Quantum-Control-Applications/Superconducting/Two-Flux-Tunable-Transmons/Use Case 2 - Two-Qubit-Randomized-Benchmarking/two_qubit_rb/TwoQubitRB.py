...
class TwoQubitRb_AS:
    ...
    def __init__(
        ...
        self.single_qubit_gate_generator: Callable[[Baking, int, float, float, float], None]
        ...
        self.two_qubit_gate_generators: Dict[Literal["sqr_iSWAP", "CNOT", "CZ"], Callable[[Baking, int, int], None]]
        ...
        self._rb_baker = RBBaker(
            config, single_qubit_gate_generator, two_qubit_gate_generators, self._interleaving_gate, self._command_registry
        )
